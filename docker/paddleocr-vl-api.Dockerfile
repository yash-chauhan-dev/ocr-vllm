...
# ==========================================
# PaddleOCR Pipeline Dockerfile (dynamic vLLM IP)
# ==========================================
...
RUN apt-get update \
    && apt-get install -y libgl1 gettext-base wget \
    && rm -rf /var/lib/apt/lists/*
...
# Optional offline model preload
...
COPY --chown=paddleocr:paddleocr config/pipeline_config.yaml /home/paddleocr/pipeline_config.yaml
